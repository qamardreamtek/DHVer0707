...
namespace DhRadzen
{
    public class DhComponent : ComponentBase, IDisposable
    {
        ...
        private DotNetObjectReference<DhComponent> reference;

        protected DotNetObjectReference<DhComponent> Reference
        {
            get
            {
                if (reference == null)
