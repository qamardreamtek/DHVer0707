...
namespace DhRadzen
{
    public class DhRadzenComponent : ComponentBase, IDisposable
    {
        ...
        private DotNetObjectReference<DhRadzenComponent> reference;

        protected DotNetObjectReference<DhRadzenComponent> Reference
        {
            get
            {
                if (reference == null)
