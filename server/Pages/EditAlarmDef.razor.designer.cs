...
{
    public partial class EditAlarmDefComponent : ComponentBase
    {
        ...
        {
            var mark10Sqlexpress04GetAlarmDefByAlarmCodeResult = await Mark10Sqlexpress04.GetAlarmDefByAlarmCode($"{AlarmCode}");
            alarmdef = mark10Sqlexpress04GetAlarmDefByAlarmCodeResult;
        }
