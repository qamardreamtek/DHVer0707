...
{
    public partial class AddProgMstPageComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(RadzenDh5.Models.Mark10Sqlexpress04.ProgMst args)
        {
            ...
            catch (System.Exception mark10Sqlexpress04CreateProgMstException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new ProgMst!" });
            }
        }
