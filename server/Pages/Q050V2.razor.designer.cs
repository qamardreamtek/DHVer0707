...
{
    public partial class Q050V2Component : ComponentBase
    {
        ...
        protected RadzenGrid<RadzenDh5.Models.Mark10Sqlexpress04.InMst> grid0;
        ...
        protected IEnumerable<RadzenDh5.Models.Mark10Sqlexpress04.InMst> getInMstsResult
        {
            get
            {
                return _getInMstsResult;
            }
            set
            {
                if (!object.Equals(_getInMstsResult, value))
                {
                    var args = new PropertyChangedEventArgs(){ Name = "getInMstsResult", NewValue = value, OldValue = _getInMstsResult };
                    _getInMstsResult = value;
        ...
        public IList<Models.Mark10Sqlexpress04.InMst> inMstsList2 { get; set; }

        protected override void OnInitialized()
        {

            inMstsList2 = AppDb.InMsts.ToList();

            //getInDtlsResult = AppDb.InDtls.ToList();
            //getInSnosResult = AppDb.InSnos.ToList();
        }
