...
{
    public partial class AddEquCmdDetailLogComponent : ComponentBase
    {
        ...
        {
            equcmddetaillog = new RadzenDh5.Models.Mark10Sqlexpress04.EquCmdDetailLog(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(RadzenDh5.Models.Mark10Sqlexpress04.EquCmdDetailLog args)
        {
            try
            {
                var mark10Sqlexpress04CreateEquCmdDetailLogResult = await Mark10Sqlexpress04.CreateEquCmdDetailLog(equcmddetaillog);
                DialogService.Close(equcmddetaillog);
            }
            catch (System.Exception mark10Sqlexpress04CreateEquCmdDetailLogException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new EquCmdDetailLog!" });
            }
        }
